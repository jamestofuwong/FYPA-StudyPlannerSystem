export type PanelId = 'dashboard' | 'import' | 'scraping' | 'planners' | 'units' | 'cloud-sync' | 'settings' | 'user-guide';

export const PANEL_IDS: PanelId[] = ['dashboard', 'import', 'scraping', 'planners', 'units', 'cloud-sync', 'settings', 'user-guide'];
