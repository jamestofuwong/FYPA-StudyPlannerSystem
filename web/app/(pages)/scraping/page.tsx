          ...
          <div className={styles.card}>
            ...
            <div style={{ background: 'var(--card-bg)', border: '1px solid var(--panel-border)', borderRadius: 4, padding: 14, marginBottom: 14 }}>
              ...
              <div className={styles.btnGroup}>
                <button className={styles.btnPrimary} onClick={() => showToast('Testing connection to portal...', 'info')}>
                  🔌 Test Connection
                </button>
                <button className={styles.btnSecondary} onClick={() => showToast('Credentials saved for this session.', 'success')}>
                  💾 Save Credentials
                </button>
              </div>
            </div>

            <div className={styles.cardTitle} style={{ marginTop: 4 }}>
            ...
            <div className={styles.formGrid2}>
              ...
              <div className={styles.formGroup}>
                ...
                <select className={styles.formSelect}>
                  <option>Full Scrape</option>
                  <option>Delta (New Only)</option>
                  <option>Specific Cohort</option>
                </select>
              </div>
            </div>
            <div className={styles.btnGroup}>
              <button className={styles.btnPrimary} onClick={() => showToast('Scraping initiated...', 'info')}>
                🕷️ Scrape Student Data
              </button>
              <button className={styles.btnSuccess} onClick={() => showToast('Scraping scheduled for 11:00 PM tonight.', 'info')}>
                ⏰ Schedule Scrape
              </button>
              <button className={styles.btnDanger} onClick={() => showToast('Scraping cancelled.', 'error')}>
                ⛔ Stop
              </button>
            </div>
          </div>
            ...
            {[
              ...
              <div
                ...
                style={{
                  marginBottom: 3,
                  color:
                    l.cls === 'info' ? 'var(--accent-blue)' : l.cls === 'warn' ? 'var(--accent-yellow)' : 'var(--accent-green)',
                }}
              >
                {l.msg}
              </div>
            ...
            <table className={styles.table}>
              ...
              <tbody>
                {[
                  ...
                  { id: 'CS2020-0007', name: 'Priya d/o Krishnan', prog: 'CSF', yr: 4, units: 31, gpa: 2.81, at: '01-Mar 10:42', s: 'OK', sc: 'badgeGreen' },
                  { id: 'CS2022-0055', name: 'Muhammad Hafiz bin Ramli', prog: 'SE', yr: 2, units: 15, gpa: 3.1, at: '01-Mar 10:42', s: 'OK', sc: 'badgeGreen' },
                  { id: 'CS2021-0066', name: 'Sarah Tan Mei Lin', prog: 'SE', yr: 3, units: 26, gpa: 3.89, at: '01-Mar 10:42', s: 'OK', sc: 'badgeGreen' },
                  { id: 'CS2023-0004', name: 'Raj Kumar s/o Suresh', prog: 'IS', yr: 1, units: 8, gpa: 3.2, at: '01-Mar 10:42', s: 'OK', sc: 'badgeGreen' },
                ].map((r) => (
                  <tr key={r.id}>
                    <td>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
              {[
                ...
                <div key={s.label} className={`${styles.statCard} ${styles[s.cls as keyof typeof styles]}`} style={{ margin: 0 }}>
                  ...
                  <div className={styles.statValue} style={s.label === 'Last Sync' ? { fontSize: 18 } : {}}>
                    {s.value}
                  </div>
