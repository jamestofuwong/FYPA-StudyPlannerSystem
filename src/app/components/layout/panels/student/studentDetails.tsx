                ...
                <div className={styles.formGrid2}>
                    <div>
                        ...
                        <div className={styles.fieldValue}>
                            {student.studentName ?? <span className={styles.fieldValueMuted}>—</span>}
                        </div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <span className={`${styles.badge} ${student.status === 'Active' ? styles.badgeGreen : styles.badgeRed}`}>
                            {student.status}
                        </span>
                    </div>
                    <div>
